...
// string nama[3] = {'Nazril Anbiya Rasyada', 'Jonathan Andrew', 'M. Iqbal Fahrezi'}
// string nim[3] = {'310124023851', '310124023844', '310124023855'}
...
void setup() {
  Serial.begin(115200);
  keypad.setDebounceTime(500);  // atur debounce agar tidak ganda
...
void loop() {
  ...
  if (key == '1') {
    value = "Jonathan Andrew Wijaya, Nazril Anbiya Rasyada, Muhammad Iqbal Fahrezi";
  } else if (key == '2') {
    value = "310124023844, 31012402351, 310124023855";
  } else {
    value = key;
  }
